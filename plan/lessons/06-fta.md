# 06. FTA and conjugate root pairs
...
- `fta` FTA and conjugate root pairs

## Prerequisites (must already be learned)
- Unit-level: Reciprocal functions are already in the bank. These six skills finish rational graphing on top of polynomials.
