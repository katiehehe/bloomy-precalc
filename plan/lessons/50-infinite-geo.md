# 50. Infinite geometric series and convergence

- Skill id: `infinite-geo`
- Unit: Series (Unit 8, block finish)
- Status: planned
...
- Unit-level: Sequences are already in the bank. These six skills are the series and proof layer. Independent of trig.
