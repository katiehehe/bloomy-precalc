# 10. Graphing inverse trig with domain restrictions

- Skill id: `inverse-graphs`
...
- `inverse-graphs` Graphing inverse trig with domain restrictions

## Prerequisites (must already be learned)
- Unit-level: The core-trig spine is already in the bank, including the unit circle. These 12 skills are the missing analytic layer.
