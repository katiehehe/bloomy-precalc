# 43. Foci and eccentricity

- Skill id: `eccentricity`
- Unit: Conics (Unit 7, block finish)
- Status: ready
- This skill is already taught by the Base Camp lesson `conics`. The Journey links to it; do not rebuild.
...
- `eccentricity` Foci and eccentricity

## Prerequisites (must already be learned)
- Unit-level: Circles and parabolas are already in the bank. These six skills complete the family. They need the distance formula, not trig.
