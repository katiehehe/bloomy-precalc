# 55. Limits from graphs and tables

- Skill id: `limits-graph`
- Unit: Calculus readiness (Unit 9, block finish)
- Status: planned
...
- `limits-graph` Limits from graphs and tables

## Prerequisites (must already be learned)
- Unit-level: Last in a full precalculus year. Graphical meaning before algebraic tricks.
