# 23. Polar-rectangular conversion

- Skill id: `polar-rect`
- Unit: Polar and complex polar (Unit 3, block plane)
- Status: ready
- This skill is already taught by the Base Camp lesson `polar-graphs`. The Journey links to it; do not rebuild.
...
- `polar-rect` Polar-rectangular conversion

## Prerequisites (must already be learned)
- Unit-level: Conversion is sine and cosine, so this waits on trig completion. Roses and limaçons are trig graphs in polar form.
