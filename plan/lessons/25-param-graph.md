# 25. Graphing parametrics

- Skill id: `param-graph`
- Unit: Parametrics (Unit 4, block plane)
- Status: ready
- This skill is already taught by the Base Camp lesson `parametrics`. The Journey links to it; do not rebuild.
...
- `param-graph` Graphing parametrics

## Prerequisites (must already be learned)
- Unit-level: Two functions of one input. Circular models reuse the unit circle.
