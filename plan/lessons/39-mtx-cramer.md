# 39. Matrix solutions and Cramer's rule

- Skill id: `mtx-cramer`
- Unit: Matrices (Unit 6, block plane)
- Status: planned
...
- `mtx-cramer` Matrix solutions and Cramer's rule

## Prerequisites (must already be learned)
- Unit-level: Part of the 22-skill hole, but it does not wait on trig. Multiply before treating matrices as transformations.
