...
export const quiz: LessonQuiz = {
  ...
  summit: [
    ...
    },
    {
      ...
      choices: [
        { text: "it mixes $\\cos^2 x$ and $\\sin x$; use $\\cos^2 x = 1 - \\sin^2 x$ to reach a single function first", correct: true, explain: "Factoring a quadratic needs one function. Converting gives $\\sin x - \\sin^2 x = 0$, i.e. $\\sin x\\,(1 - \\sin x) = 0$." },
